...
The certified census of all 37 built-in codes is published as the
...
- a built-in registry of 37 named codes across eleven families
  ...
  Reed-Muller, grid); see `docs/qldpc-survey.md` for certified results;
