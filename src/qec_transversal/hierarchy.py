...
class HierarchyAnalysis:
    ...
    def kernel_certificate(self) -> dict:
        """Smith-form completeness certificate (see
        :func:`smith_kernel_certificate`); verify independently with
        :func:`check_kernel_certificate`."""
...
def check_kernel_certificate(
    ...
    from .gf2 import rank as f2_rank
