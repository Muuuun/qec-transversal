...
:func:`.permutation.describe_permutation` (permutation gates), so a bug
...
from ..utils.gf2 import nullspace, rowspace_residues
...
def structural_permutations(code: CSSCode, *, cap: int = 8) -> list[np.ndarray]:
    ...
    :func:`.permutation.describe_permutation` before any gate is trusted.
    """
