...
from .strict import analyze_local_clifford
...
class MonomialGenerator:
    ...
    #: The dense ``2n x 2n`` physical symplectic matrix (permutation included).
...
def strict_cross_check(
    ...
    computed by :func:`~.strict.analyze_local_clifford` and
